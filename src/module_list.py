...
ext_modules = [
    ...
    Extension('sage.geometry.polyhedron.combinatorial_polyhedron.check_bad_face',
              sources = ['sage/geometry/polyhedron/combinatorial_polyhedron/check_bad_face.pyx'],
