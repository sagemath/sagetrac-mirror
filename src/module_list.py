...
ext_modules = [
    ...
    OptionalExtension('sage.libs.scip.constraint',
              ['sage/libs/scip/constraint.pyx'],
              condition = os.path.isfile(SAGE_INC + "/scip/scip.h"),
              include_dirs = [SAGE_INC+'/scip/'],
              language = 'c++',
              libraries = ["scip", "lpispx", "soplex", "nlpi.cppad"],
              package = 'scipoptsuite'),

    OptionalExtension('sage.libs.scip.object',
              ['sage/libs/scip/object.pyx'],
              condition = os.path.isfile(SAGE_INC + "/scip/scip.h"),
              include_dirs = [SAGE_INC+'/scip/'],
              language = 'c++',
              libraries = ["scip", "lpispx", "soplex", "nlpi.cppad"],
    ...
    OptionalExtension('sage.libs.scip.scip',
              ['sage/libs/scip/scip.pyx'],
              condition = os.path.isfile(SAGE_INC + "/include/scip/scip.h"),
              include_dirs = [SAGE_INC+'/scip/'],
              language = 'c++',
              libraries = ["scip", "lpispx", "soplex", "nlpi.cppad"],
              package = 'scipoptsuite'),
                      
    OptionalExtension('sage.libs.scip.variable',
              ['sage/libs/scip/scip.pyx'],
              condition = os.path.isfile(SAGE_INC + "/include/scip/scip.h"),
              include_dirs = [SAGE_INC+'/scip/'],
              language = 'c++',
