...
ext_modules = [
    ...
    Extension('sage.quadratic_forms.enumerate_short_vectors.enumerate_short_vectors_boost_python',
              sources = ['sage/quadratic_forms/enumerate_short_vectors/enumerate_short_vectors_boost_python.cpp',
