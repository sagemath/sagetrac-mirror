...
lazy_import('sage.manifolds.differentiable.examples.parametrized_surface3d', 'ParametrizedSurface3D')
lazy_import('sage.manifolds.differentiable.examples.surface3d_generators', 'surfaces')
