...
def prime_powers_intlist(Py_ssize_t B):
    ...
    EXAMPLES::
        ...
        sage: from sage.lfunctions.helper_lseries import prime_powers_intlist
        ...
        sage: sorted(prime_powers_intlist(10^6)[0][1:]) == prime_powers(10^6)
        True
...
def extend_multiplicatively(IntList a):
    ...
    EXAMPLES::
        ...
        sage: from sage.lfunctions.helper_lseries import extend_multiplicatively
...
def extend_multiplicatively_generic(list a):
    ...
    EXAMPLES::
        ...
        sage: from sage.lfunctions.helper_lseries import extend_multiplicatively_generic
