...
cdef inline Integer shift_floor(Integer x, long shift):
    r"""
...
cdef inline Integer shift_ceil(Integer x, long shift):
    r"""
    Return `x / 2^s` where `s` is the value of ``shift``, rounded towards
    `+\infty`. For internal use.
