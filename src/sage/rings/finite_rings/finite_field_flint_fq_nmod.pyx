...
cdef class FiniteField_flint_fq_nmod(FiniteField):
    ...
    def __init__(self, p, modulus, name=None):
        ...
        EXAMPLE::
            ...
            sage: from sage.rings.finite_rings.finite_field_flint_fq_nmod import FiniteField_flint_fq_nmod
    ...
    def __reduce__(self):
        ...
        EXAMPLE::
            ...
            sage: type(k)
            <type 'sage.rings.finite_rings.finite_field_flint_fq_nmod.FiniteField_flint_fq_nmod'>
    ...
    def __richcmp__(left, right, op):
        ...
        EXAMPLE::
            ...
            sage: k = FiniteField(2^17, 'a', impl='flint_fq_nmod')
            sage: j = FiniteField(2^18, 'b', impl='flint_fq_nmod')
            sage: k == j
            False
