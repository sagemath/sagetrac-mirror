...
cdef class FiniteFieldElement_flint_fq_nmod(FinitePolyExtElement):
    ...
    EXAMPLE::
        ...
        a
        sage: type(a)
        <type 'sage.rings.finite_rings.element_flint_fq_nmod.FiniteFieldElement_flint_fq_nmod'>
    ...
    def __init__(FiniteFieldElement_flint_fq_nmod self, object parent, object x):
        ...
        TEST::
            ...
            sage: from sage.rings.finite_rings.element_flint_fq_nmod import FiniteFieldElement_flint_fq_nmod
    ...
    cdef int _cmp_c_impl(FiniteFieldElement_flint_fq_nmod self, Element other) except -2:
        ...
        if fq_nmod_equal(self.val, (<FiniteFieldElement_flint_fq_nmod>other).val, self._cparent):
            ...
            r = cmp(fmpz_poly_degree(self.val), fmpz_poly_degree((<FiniteFieldElement_flint_fq_nmod>other).val))
            if r:
                return r
            return cmp(self.polynomial(), other.polynomial())

    def __richcmp__(FiniteFieldElement_flint_fq_nmod left, object right, int op):
        """
        ...
        EXAMPLE::
            ...
            sage: K.<a> = GF(2^100, impl='flint_fq_nmod')
            sage: a < a^2
            True
            sage: a > a^2
            False
