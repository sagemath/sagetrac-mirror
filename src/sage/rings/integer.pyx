...
cdef class Integer(sage.structure.element.EuclideanDomainElement):
    ...
    def is_smooth(self, B=None, P=None, td_bound=1000000, proof=None):
        r"""
        Tests whether this integer is only divisible by primes up to B (or in P)

        INPUT:

        - ``B`` -- an integer bound: smoothness is determined by the condition `p \le B`
        ...
        .. NOTE::
            ...
            Testing smoothness sequentially is generally slower than batch methods or
            sieves.
    ...
    def smooth_part(self, B=None, P=None, td_bound=1000000, proof=None):
        r"""
        Returns the smooth part of this integer, as a factorization into small primes.

        INPUT:

        - ``B`` -- an integer bound: smoothness determined by the condition `p \le B`
