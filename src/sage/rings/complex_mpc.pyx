...
cdef class MPComplexField_class(sage.rings.ring.Field):
    def __init__(self, int prec=53, rnd="RNDNN"):
        ...
        self.__real_field = real_mpfr.create_RealFloatingPointField(prec, rnd=_mpfr_rounding_modes[rnd_re(n)])
        self.__imag_field = real_mpfr.create_RealFloatingPointField(prec, rnd=_mpfr_rounding_modes[rnd_im(n)])
    ...
    def _set(self, z, y=None, base=10):
        ...
        if y is None:
            ...
            # then, no imaginary part
                ...
                zz = sage.rings.real_mpfr.create_RealFloatingPointField(self._parent.prec())(z)
