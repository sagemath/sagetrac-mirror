...
cdef class ETuple:
    ...
    cdef list nonzero_positions(ETuple self, bint sort=False):
        """
    ...
    cdef common_nonzero_positions(ETuple self, ETuple other, bint sort=False):
        """
    ...
    cdef list nonzero_values(ETuple self, bint sort=True):
        """
