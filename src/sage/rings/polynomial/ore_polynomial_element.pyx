...
cdef class OrePolynomial(AlgebraElement):
    ...
    cdef OrePolynomial _new_constant_poly(self, RingElement a, Parent P, char check=0):
        r"""
    ...
    cdef list coefficients(self, sparse=True):
        r"""
