...
cdef class RealField_class(sage.rings.ring.Field):
    ...
    cpdef _coerce_map_from_(self, S):
        ...
        TESTS::
            ...
            sage: 1.0 - ZZ(1) - int(1) - long(1) - QQ(1) - RealField(100)(1) - AA(1) - RLF(1)  # py2
            -6.00000000000000
            sage: 1.0 - ZZ(1) - int(1) - QQ(1) - RealField(100)(1) - AA(1) - RLF(1)  # py3
            -5.00000000000000
...
cdef class RealNumber(sage.structure.element.RingElement):
    ...
    def __long__(self):
        ...
        EXAMPLES::
            ...
            sage: RR(pi).__long__()  # py2
            3L
            sage: type(RR(pi).__long__())  # py2
            <type 'long'>
        """
        if not mpfr_number_p(self.value):
