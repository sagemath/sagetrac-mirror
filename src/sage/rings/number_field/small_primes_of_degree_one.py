...
.. TODO::
    ...
    primes of relative degree one.  There are questions of finding primes of
    exact degree larger than one.  In short, if you can contribute, please do!
...
class Small_primes_of_degree_one_iter():
    ...
    def next(self):
        ...
        We test that :trac:`6396` is fixed. Note that the doctest is flagged as random
