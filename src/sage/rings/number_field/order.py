...
class AbsoluteOrder(Order):
    ...
    def conductor(self, in_integral_closure=True):
        ...
        The index of an order in its integral closure is always in the
        conductor. For quadratic number fields, the conductor is principally
        generated by the index. ::

            sage: K.<a> = NumberField(x**2-5)
            sage: O = K.order(10*a)
            sage: O.index_in(O.integral_closure())
            20
            sage: O.conductor()
            Fractional ideal (20)
        ...
        This example is Example 9.1 of [KP2005]_ . ::
