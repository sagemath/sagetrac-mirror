...
Which you can't do with hyperplane arrangements::
    ...
    TypeError: unsupported operand parent(s) for '+': 'Hyperplane
    arrangements in 3-dimensional linear space over Rational Field with
    coordinates x, y, z' and 'Hyperplane arrangements in 3-dimensional
    linear space over Rational Field with coordinates x, y, z'
"""
