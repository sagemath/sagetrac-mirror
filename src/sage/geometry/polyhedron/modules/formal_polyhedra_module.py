...
class FormalPolyhedraModule(CombinatorialFreeModule):
    ...
    A three-dimensional vector space of polyhedra::
        ...
        sage: basis012 = [I01, I11, I12]
        sage: M = FormalPolyhedraModule(QQ, 1, basis=basis012); M
    ...
    The infinite-dimensional vector space generated by all intervals with integer endpoints
    (and the empty set)::

        sage: from sage.geometry.polyhedron.parent import Polyhedra
        sage: MZ = FormalPolyhedraModule(QQ, 1, basis=Polyhedra(ZZ, 1)); MZ
        Free module generated by Polyhedra in ZZ^1 over Rational Field

    The three-dimensional vector space from above should coerce into it::

        sage: MZ.has_coerce_map_from(M)   # known bug
        True

    The same three-dimensional space constructed explicitly as a subspace
    of the infinite-dimensional space::

        sage: MS = MZ.submodule([MZ(I01), MZ(I11), MZ(I12), 2*MZ(I11) - MZ(I12)]); MS
        Free module generated by {0, 1, 2} over Rational Field
        sage: MZ.has_coerce_map_from(MS)
        True
