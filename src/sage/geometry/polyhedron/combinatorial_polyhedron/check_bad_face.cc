...
template <typename Hreptype>
inline int check_bad_face(size_t **PolyIneq, size_t n_coatoms, size_t m, uint64_t LHS, Hreptype *Hrep, size_t n_Hrep, size_t e, size_t group_action, size_t group_action_inv){
...
template <typename Hreptype>
inline int check_bad_face_original(size_t **PolyIneq, size_t n_coatoms, size_t m, uint64_t LHS, Hreptype *Hrep, size_t n_Hrep, size_t e, size_t group_action, size_t group_action_inv){
    // For a bad face in in the Kunz Cone we check
    // wether with the inequalites from (4.1) and negation
    // of (4.2)
    // (see paper "Wilf's conjecture in fixed multiplicity")
...
template <typename Hreptype>
int check_bad_face(size_t **PolyIneq, size_t n_coatoms, size_t m, uint64_t LHS, Hreptype *Hrep, size_t n_Hrep, size_t e){
