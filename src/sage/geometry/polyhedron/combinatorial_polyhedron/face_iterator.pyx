...
cdef class FaceIterator(SageObject):
    ...
    cdef size_t set_coatom_rep(self) except -1:
        ...
        return bit_repr_to_coatom_rep(self.structure.face, coatoms, n_coatoms,
    ...
    cdef size_t set_atom_rep(self) except -1:
        ...
        """
        cdef size_t face_length = self.structure.face_length
        return bit_repr_to_Vrep_list(self.structure.face, self.structure.atom_rep, face_length)
