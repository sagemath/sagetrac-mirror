...
class PiecewiseFunction(BuiltinFunction):
    ...
    class EvaluationMethods(object):
        ...
        def fourier_series_cosine_coefficient(self, parameters, variable, n, L):
            r"""
        ...
        def fourier_series_sine_coefficient(self, parameters, variable, n, L):
            r"""
            Returns the n-th Fourier series coefficient of
            `\sin(n\pi x/L)`, `b_n`.
        ...
        def fourier_series_partial_sum(self, parameters, variable, N, L):
            r"""
