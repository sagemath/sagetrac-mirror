...
class Function_crootof(BuiltinFunction):
    ...
    EXAMPLES::
        ...
        sage: c.n()     # known bug (Trac #24397)
        -0.790667188814418 + 0.300506920309552*I
        sage: c.n(100)  # known bug (Trac #24397)
        -0.79066718881441764449859281847 + 0.30050692030955162512001002521*I
        sage: (c^6 + c + 1).n(100) < 1e-25  # known bug (Trac #24397)
        True
    """
    def __init__(self):
        """
    ...
    def _evalf_(self, poly, index, parent=None, algorithm=None):
        ...
        EXAMPLES::
            ...
            sage: complex_root_of(x^2-2, 1).n()  # known bug (Trac #24397)
            1.41421356237310
