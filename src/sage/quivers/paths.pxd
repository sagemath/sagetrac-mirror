...
from sage.data_structures.bounded_integer_sequences cimport biseq_t, biseq_dealloc, biseq_getitem, biseq_init_concat, biseq_startswith, biseq_contains, biseq_max_overlap, biseq_slice, biseq_init_list
