...
from sage.misc.latex_macros import sage_mathjax_macros, sage_latex_macros
...
def find_sage_dangling_links(app, env, node, contnode):
    ...
    debug_inf(app, f"Searching {reftarget} from {doc}")
    ...
    try:
        ...
        debug_inf(app, f"-- no module or class for :{reftype}:{reftarget}")
        return None
