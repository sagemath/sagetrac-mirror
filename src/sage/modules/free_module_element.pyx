...
`\QQ` the following arithmetic is not defined::
    ...
    'Vector space of dimension 5 over Rational Field' and 'Vector space
    of dimension 5 over Finite Field of size 7'
...
cdef class FreeModuleElement(Vector):   # abstract base class
    ...
    def outer_product(self, right):
        ...
        But some inputs are not compatible, even if vectors. ::
            ...
            ...
            TypeError: no common canonical parent for objects with parents:
            'Full MatrixSpace of 2 by 1 dense matrices over Finite Field of size 5'
            and 'Full MatrixSpace of 1 by 4 dense matrices over Finite Field of size 7'
