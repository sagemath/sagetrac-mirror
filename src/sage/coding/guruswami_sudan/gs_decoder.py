...
class GRSGuruswamiSudanDecoder(Decoder):
    ...
    def __init__(self, code, tau = None, parameters = None, interpolation_alg = None, root_finder = None):
        ...
        if callable(interpolation_alg) and not isinstance(interpolation_alg, numbers.Integral):
        ...
        if callable(root_finder) and not isinstance(root_finder, numbers.Integral):
