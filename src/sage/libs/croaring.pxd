...
cdef extern from "roaring/roaring.h":
    ...
    bool_alias roaring_bitmap_get_copy_on_write(const roaring_bitmap_t* r)
    void roaring_bitmap_set_copy_on_write(roaring_bitmap_t* r, bool_alias cow)
    void roaring_bitmap_add(roaring_bitmap_t *r, uint32_t x)
    bool_alias roaring_bitmap_add_checked(roaring_bitmap_t *r, uint32_t x)
    ...
    bool_alias roaring_bitmap_remove_checked(roaring_bitmap_t *r, uint32_t x)
    ...
    bool_alias roaring_bitmap_intersect(const roaring_bitmap_t *x1, const roaring_bitmap_t *x2)
    ...
    bool_alias roaring_bitmap_select(const roaring_bitmap_t *r, uint32_t rank, uint32_t *element)
    ...
    bool_alias roaring_advance_uint32_iterator(roaring_uint32_iterator_t *it)
    uint32_t roaring_read_uint32_iterator(roaring_uint32_iterator_t *it, uint32_t* buf, uint32_t count)
    bool_alias roaring_move_uint32_iterator_equalorlarger(roaring_uint32_iterator_t *it, uint32_t val)
