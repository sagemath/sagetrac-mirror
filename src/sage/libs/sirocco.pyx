...
cdef list[list] contpath_mp(int deg, list values, RealNumber y0r, RealNumber y0i, int prec):
    """
...
cdef list[list] contpath_mp_comps(int deg, list values, RealNumber y0r, RealNumber y0i, int prec, list otherdegs, list othercoefs):
    """
    Mimics :func:`contpath`, but with the following differences:
...
cdef list[list] contpath(int deg, list values, double y0r, double y0i):
    """
    INPUT:
...
cdef list[list] contpath_comps(int deg, list values, double y0r, double y0i, list otherdegrees, list othercoefs):
    """
    INPUT:
