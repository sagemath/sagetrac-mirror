...
cdef extern from "sage/libs/pari/parisage.h":
    ...
    const bb_field *get_F2xq_field(void **E, GEN T)
    ...
    const bb_group * get_F2xqE_group(void **E, GEN a2, GEN a6, GEN T)
    ...
    const bb_field *get_Flxq_field(void **E, GEN T, ulong p)
    const bb_group *get_Flxq_star(void **E, GEN T, ulong p)
    ...
    const bb_group * get_FlxqE_group(void **E, GEN a4, GEN a6, GEN T, ulong p)
    ...
    const bb_group * get_FpE_group(void **E, GEN a4, GEN a6, GEN p)
    const bb_group * get_FpXQE_group(void **E, GEN a4, GEN a6, GEN T, GEN p)
    ...
    const bb_group *get_FpXQ_star(void **E, GEN T, GEN p)
    ...
    GEN     gen_matid(long n, void *E, const bb_field *S)
    ...
    GEN     gen_Gauss(GEN a, GEN b, void *E, const bb_field *ff)
    GEN     gen_Gauss_pivot(GEN x, long *rr, void *E, const bb_field *ff)
    GEN     gen_det(GEN a, void *E, const bb_field *ff)
    GEN     gen_ker(GEN x, long deplin, void *E, const bb_field *ff)
    GEN     gen_matcolmul(GEN a, GEN b, void *E, const bb_field *ff)
    GEN     gen_matmul(GEN a, GEN b, void *E, const bb_field *ff)
    GEN     image(GEN x)
    GEN     image2(GEN x)
    ...
    const bb_field *get_Fp_field(void **E, GEN p)
    ...
    GEN gen_PH_log(GEN a, GEN g, GEN ord, void *E, const bb_group *grp)
    GEN gen_Shanks_init(GEN g, long n, void *E, const bb_group *grp)
    GEN gen_Shanks(GEN T, GEN x, ulong N, void *E, const bb_group *grp)
    ...
    GEN gen_order(GEN x, GEN o, void *E, const bb_group *grp)
    GEN gen_select_order(GEN o, void *E, const bb_group *grp)

    GEN gen_plog(GEN x, GEN g0, GEN q, void *E, const bb_group *grp)
    ...
    const char **gphelp_keyword_list()
    ...
    const bb_field *get_Fq_field(void **E, GEN T, GEN p)
