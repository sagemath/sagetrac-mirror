...
- Jeroen Demeyer (2015-01-12): upgrade to PARI 2.8 (#16997)
...
cdef class gen(gen_auto):
    ...
    def ellheight(self, a, long flag=-1, unsigned long precision=0):
        """
    ...
    def dirmul(self, other):
        ...
        EXAMPLES::
            ...
            sage: L2 = pari([1,0]*10); L2.dirmul(L2)
            [1, 0, 2, 0, 2, 0, 2, 0, 3, 0, 2, 0, 2, 0, 4, 0, 2, 0, 2, 0]
        """
        cdef gen selfgen = objtogen(self)
        cdef gen othergen = objtogen(other)
        pari_catch_sig_on()
        r = P.new_gen(dirmul(selfgen.g, othergen.g))
        return r
