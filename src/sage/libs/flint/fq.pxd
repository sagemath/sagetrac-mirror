...
from sage.libs.flint.types cimport fq_ctx_t, fq_t, fmpz_t, fmpz_mod_poly_t, fslong, fulong

# cdef extern from "flint/fq.h"
cdef extern from "flint_wrap.h":
    void fq_ctx_init(fq_ctx_t ctx, const fmpz_t p, fslong d, const char *var)
    void fq_ctx_init_conway(fq_ctx_t ctx, const fmpz_t p, fslong d, const char *var)
    ...
    fslong fq_ctx_degree(const fq_ctx_t ctx)
    ...
    void fq_mul_si(fq_t rop, const fq_t op, fslong x, const fq_ctx_t ctx)
    void fq_mul_ui(fq_t rop, const fq_t op, fulong x, const fq_ctx_t ctx)
    ...
    void fq_pow_ui(fq_t rop, const fq_t op, const fulong e, const fq_ctx_t ctx)
    ...
    void fq_set_ui(fq_t rop, const fulong x, const fq_ctx_t ctx)
    void fq_set_si(fq_t rop, const fslong x, const fq_ctx_t ctx)
    void fq_set_coeff_fmpz(fq_t rop, const fmpz_t x, const fulong n, const fq_ctx_t ctx)
    ...
    void fq_frobenius(fq_t rop, const fq_t op, fslong e, const fq_ctx_t ctx)
