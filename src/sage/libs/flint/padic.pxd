...
cdef extern from "flint_wrap.h":
    ...
    fslong padic_get_val(const padic_t x)
    fslong padic_get_prec(const padic_t x)

    #* Context *******************************************************************/
    void padic_ctx_init(padic_ctx_t ctx, const fmpz_t p, fslong min, fslong max,
                    padic_print_mode mode);
    void padic_ctx_clear(padic_ctx_t ctx);
 
    int _padic_ctx_pow_ui(fmpz_t rop, fulong e, const padic_ctx_t ctx)
 
    void padic_ctx_pow_ui(fmpz_t rop, fulong e, const padic_ctx_t ctx)

    #* Memory management *********************************************************/
    void padic_init(padic_t rop);
    void padic_init2(padic_t rop, fslong N);
    ...
    void padic_set_si(padic_t rop, fslong op, const padic_ctx_t ctx);
    void padic_set_ui(padic_t rop, fulong op, const padic_ctx_t ctx);
    ...
    fslong * _padic_lifts_exps(fslong *n, fslong N);
    void _padic_lifts_pows(fmpz *pow, const fslong *a, fslong n, const fmpz_t p);
    ...
    void padic_mul(padic_t rop, const padic_t op1, const padic_t op2, 
               const padic_ctx_t ctx);
    void padic_shift(padic_t rop, const padic_t op, fslong v, const padic_ctx_t ctx);
    void padic_div(padic_t rop, const padic_t op1, const padic_t op2, 
               const padic_ctx_t ctx);
    void _padic_inv_precompute(padic_inv_t S, const fmpz_t p, fslong N);
    void _padic_inv_clear(padic_inv_t S);
    void _padic_inv_precomp(fmpz_t rop, const fmpz_t op, const padic_inv_t S);
    void _padic_inv(fmpz_t rop, const fmpz_t op, const fmpz_t p, fslong N);
    ...
    void padic_pow_si(padic_t rop, const padic_t op, fslong e, 
                  const padic_ctx_t ctx);

    #* Exponential ***************************************************************/
    fslong _padic_exp_bound(fslong v, fslong N, const fmpz_t p);
    void _padic_exp(fmpz_t rop, const fmpz_t u, fslong v, const fmpz_t p, fslong N);
    void _padic_exp_rectangular(fmpz_t rop, const fmpz_t u, fslong v, const fmpz_t p, fslong N);
    void _padic_exp_balanced(fmpz_t rop, const fmpz_t u, fslong v, const fmpz_t p, fslong N);
    ...
    #* Logarithm *****************************************************************/
    fslong _padic_log_bound(fslong v, fslong N, const fmpz_t p);
    void _padic_log(fmpz_t z, const fmpz_t y, fslong v, const fmpz_t p, fslong N);
    void _padic_log_rectangular(fmpz_t z, const fmpz_t y, fslong v, const fmpz_t p, fslong N);
    void _padic_log_satoh(fmpz_t z, const fmpz_t y, fslong v, const fmpz_t p, fslong N);
    void _padic_log_balanced(fmpz_t z, const fmpz_t y, fslong v, const fmpz_t p, fslong N);
    ...
    #* Special functions *********************************************************/
    void _padic_teichmuller(fmpz_t rop, const fmpz_t op, const fmpz_t p, fslong N);
    void padic_teichmuller(padic_t rop, const padic_t op, const padic_ctx_t ctx);
    fulong padic_val_fac_ui_2(fulong N);
    fulong padic_val_fac_ui(fulong N, const fmpz_t p);
    ...
    int _padic_fprint(FILE * file, const fmpz_t u, fslong v, const padic_ctx_t ctx);
    int padic_fprint(FILE * file, const padic_t op, const padic_ctx_t ctx);
 
    int _padic_print(const fmpz_t u, fslong v, const padic_ctx_t ctx)
