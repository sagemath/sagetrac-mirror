...
from sage.libs.flint.types cimport fq_nmod_ctx_t, fq_nmod_t, fmpz_t, nmod_poly_t, fslong, fulong

# cdef extern from "flint/fq_nmod.h"
cdef extern from "flint_wrap.h":
    void fq_nmod_ctx_init(fq_nmod_ctx_t ctx, const fmpz_t p, fslong d, const char *var)
    void fq_nmod_ctx_init_conway(fq_nmod_ctx_t ctx, const fmpz_t p, fslong d, const char *var)
    ...
    fslong fq_nmod_ctx_degree(const fq_nmod_ctx_t ctx)
    ...
    void fq_nmod_mul_si(fq_nmod_t rop, const fq_nmod_t op, fslong x, const fq_nmod_ctx_t ctx)
    void fq_nmod_mul_ui(fq_nmod_t rop, const fq_nmod_t op, fulong x, const fq_nmod_ctx_t ctx)
    ...
    void fq_nmod_pow_ui(fq_nmod_t rop, const fq_nmod_t op, const fulong e, const fq_nmod_ctx_t ctx)
    ...
    void fq_nmod_set_ui(fq_nmod_t rop, const fulong x, const fq_nmod_ctx_t ctx)
    void fq_nmod_set_si(fq_nmod_t rop, const fslong x, const fq_nmod_ctx_t ctx)
    void fq_nmod_set_coeff_fmpz(fq_nmod_t rop, const fmpz_t x, const fulong n, const fq_nmod_ctx_t ctx)
    ...
    void fq_nmod_frobenius(fq_nmod_t rop, const fq_nmod_t op, fslong e, const fq_nmod_ctx_t ctx)
