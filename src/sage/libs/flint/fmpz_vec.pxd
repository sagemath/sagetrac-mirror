...
from sage.libs.flint.types cimport fmpz, fslong, fulong, fmpz_t

# cdef extern from "flint/fmpz_vec.h"
cdef extern from "flint_wrap.h":
    fmpz * _fmpz_vec_init(fslong)
    void _fmpz_vec_clear(fmpz *, fslong)
    fulong _fmpz_vec_max_limbs(const fmpz *, fslong)
