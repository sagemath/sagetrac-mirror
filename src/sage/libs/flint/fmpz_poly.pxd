...
cdef extern from "flint/fmpz_poly.h":
    ...
    #void fmpz_poly_powers_precompute(fmpz_poly_powers_precomp_t, fmpz_poly_t)
    #void fmpz_poly_powers_clear(fmpz_poly_powers_precomp_t)
    #void fmpz_poly_rem_powers_precomp(
    #        fmpz_poly_t, const fmpz_poly_t,
    #                const fmpz_poly_t, const fmpz_poly_powers_precomp_t)
    ...
    #void fmpz_poly_evaluate_divconquer(fmpz_t, const fmpz_poly_t, const fmpz_t)
    ...
    #void fmpz_poly_debug(fmpz_poly_t)
