...
EXAMPLES::
    ...
    sage: with local_display_preferences(text='ascii_art'):
...
class SequencePrettyPrinter(SageObject):
    ...
    def __init__(self, *args, **kwds):
        ...
        EXAMPLES::
            ...
            sage: from sage.repl.rich_output.display_manager import local_display_preferences
            sage: with local_display_preferences(text=None):
            ....:     pretty_print(1, 2, 3)   # indirect doctest
            <html><script type="math/tex">\newcommand{\Bold}[1]{\mathbf{#1}}1 2 3</script></html>
...
def pretty_print(*args, **kwds):
    ...
    In the notebook, a text display preference is not specified by default, so
    Latex output is used::
        ...
        sage: with local_display_preferences(text=None):
        ....:     pretty_print("Integers = ", ZZ)  # trac 11775
    ...
    To typeset LaTeX code as-is, use :class:`LatexExpr`::
        ...
        sage: with local_display_preferences(text=None):
        ....:     pretty_print(LatexExpr(r"\frac{x^2 + 1}{x - 2}"))
