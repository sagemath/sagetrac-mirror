...
class local_display_preferences(object):
    ...
    def __init__(self, **kwds):
        ...
        EXAMPLES::
            ...
            sage: with local_display_preferences(text=None, graphics='disable'):
            ....:     dm.preferences
            Display preferences:
            * graphics = disable
            * supplemental_plot = never
    ...
    def __enter__(self):
        """
        Enter the local display preferences context.
        """
        dm = self._display_manager
        self._original_prefs = DisplayPreferences(dm.preferences)
    ...
    def __exit__(self, exception_type, value, traceback):
        """
        Exit the local display preferences context.
        """
        dm = self._display_manager
        for key in self._local_prefs:
