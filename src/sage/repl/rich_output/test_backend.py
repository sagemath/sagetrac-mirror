...
We switch to the test backend for the remainder of this file::
    ...
    sage: from sage.repl.rich_output.test_backend import BackendTest, _TestObject
    ...
    {<class 'sage.repl.rich_output.output_basic.OutputPlainText'>:
     <class 'sage.repl.rich_output.test_backend._TestOutputPlainText'>}
...
class _TestOutputPlainText(OutputPlainText):
    ...
    def __init__(self, *args, **kwds):
        ...
        EXAMPLES::
            ...
            sage: from sage.repl.rich_output.test_backend import _TestOutputPlainText
...
class _TestObject(SageObject):
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: from sage.repl.rich_output.test_backend import _TestObject
...
class BackendTest(BackendBase):
    ...
    def supported_output(self):
        ...
        :class:`~sage.repl.rich_repr.test_backend._TestOutputPlainText`
