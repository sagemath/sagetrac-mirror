...
class Graphics(WithEqualityById, SageObject):
    ...
    def save_image(self, filename=None, *args, **kwds):
        ...
        EXAMPLES::
            ...
            ....:     filename = os.path.join(d, 'test.png')
            ....:     c.save_image(filename, xmin=-1, xmax=3, ymin=-1, ymax=3)
        """
    ...
    def save(self, filename, **kwds):
        ...
        EXAMPLES::
            ...
            sage: f = NamedTemporaryFile(suffix=".png", delete=False)
            sage: f.close() # we only use the name
            sage: c.save(f.name, xmin=-1, xmax=3, ymin=-1, ymax=3)
        ...
        is fixed (same issue as :trac:`7981` and :trac:`8632`)::
            ...
            sage: import tempfile
            sage: with tempfile.TemporaryDirectory() as d:
            ....:     filename=os.path.join(d, 'test2.png')
            ....:     a.save(filename)
