...
Test deprecation::
    ...
    See http://trac.sagemath.org/10057 for details.
    12
"""
...
lazy_import('sage.misc.temporary_file', ('tmp_dir', 'tmp_filename', 'delete_tmpfiles'), deprecation=10057)
lazy_import('sage.misc.banner', ('version', 'banner'), deprecation=10057)
lazy_import('sage.env', '*', deprecation=10057)
lazy_import('sage.misc.decorators', ('infix_operator', 'decorator_defaults', 'sage_wraps'), deprecation=10057)
lazy_import('sage.misc.all', ('prod', 'running_total', 'balanced_sum', 'is_64_bit', 'is_32_bit'), deprecation=10057)
mul = prod
