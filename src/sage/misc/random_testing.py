...
def random_testing(fn):
    ...
    See :func:`sage.misc.random_testing._test_add_commutes` for a
...
@random_testing
def _test_add_commutes(trials, verbose=False):
    r"""
    ...
    EXAMPLES::
        ...
        sage: from sage.misc.random_testing import _test_add_commutes
        sage: _test_add_commutes(2, verbose=True, seed=0)
        a == -4, b == 0 ...
        Passes!
        a == -1/2, b == -1/95 ...
        Passes!
        sage: _test_add_commutes(10)
        sage: _test_add_commutes(1000) # long time
    """
...
@random_testing
def _test_add_is_mul(trials, verbose=False):
    r"""
    ...
    :func:`sage.misc.random_testing._test_add_commutes`.
    ...
    EXAMPLES::
        ...
        sage: from sage.misc.random_testing import _test_add_is_mul
    ...
    *seed* to 0.
    ...
    ::
        ...
        sage: _test_add_is_mul(2, verbose=True, seed=0)
        a == -4, b == 0 ...
        Random testing has revealed a problem in _test_add_is_mul
        Please report this bug!  You may be the first
        person in the world to have seen this problem.
        Please include this random seed in your bug report:
        Random seed: 0
    ...
    ::
        ...
        sage: _test_add_is_mul(10, verbose=True) # random
        a == -2/7, b == 1 ...
        Random testing has revealed a problem in _test_add_is_mul
        Please report this bug!  You may be the first
        person in the world to have seen this problem.
    ...
    :func:`_test_add_is_mul` failure.  We can specify the same
    *random_seed* that was found in the bug report, and we will get the
    exact same failure so that we can debug the "problem".

    ::

        sage: _test_add_is_mul(10, verbose=True, seed=216390410596009428782506007128692114173)
        a == -2/7, b == 1 ...
        Random testing has revealed a problem in _test_add_is_mul
        Please report this bug!  You may be the first
        person in the world to have seen this problem.
