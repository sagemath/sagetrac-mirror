...
for categories), but deriving only from Parent::
    ...
    sage: from sage.misc.test_nested_class import _TestParent1, _TestParent2, _TestParent3, _TestParent4
    sage: P = _TestParent1()
...
class _TestParent1(Parent):
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: sage.misc.test_nested_class._TestParent1()
            <sage.misc.test_nested_class._TestParent1_with_category object at ...>
        """
...
class _TestParent2(Parent, metaclass=NestedClassMetaclass):
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: sage.misc.test_nested_class._TestParent2()
            Traceback (most recent call last):
            ...
            TypeError: metaclass conflict: the metaclass of a derived class must be a (non-strict) subclass of the metaclasses of all its bases
        """
...
class _TestParent3(UniqueRepresentation, Parent):
    ...
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: sage.misc.test_nested_class._TestParent3()
            <sage.misc.test_nested_class._TestParent3_with_category object at ...>
        """
        from sage.categories.sets_cat import Sets
        Parent.__init__(self, category = Sets())
...
class _TestParent4(Parent, metaclass=ClasscallMetaclass):
    def __init__(self):
        ...
        EXAMPLES::
            ...
            sage: sage.misc.test_nested_class._TestParent4()
            <sage.misc.test_nested_class._TestParent4_with_category object at ...>
        """
        from sage.categories.sets_cat import Sets
        Parent.__init__(self, category=Sets())
