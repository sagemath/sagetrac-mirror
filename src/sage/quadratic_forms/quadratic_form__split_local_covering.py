...
from sage.rings.real_mpfr import RealFloatingPointField_class, RealFloatingPointField
...
def cholesky_decomposition(self, bit_prec = 53):
    ...
    if isinstance(self.base_ring(), RealFloatingPointField_class) and (self.base_ring().prec() < bit_prec):
