...
A simplified eductional variant of the RC4 cryptosystem. It is a
...
class RC4(SageObject):
    ...
    def prga(self, n):
        ...
        if not isinstance(n, Integer):
            raise TypeError, "input n must be an integer, denoting the length of the pseudo-random sequence desired"
