...
void orthogonalize_iso(quad_cyclic_cover *qcc, double *theta, size_t nb_char, size_t* dimensions)
/* orthogonalization using Gram-Schmidt process                                                */
/* warning: this method should be called AFTER being sure that init_GS has been called         */
/* it theta is not NULL it is updated by 2*log of the diagonal from position 1 to nb_vectors   */
/* warning: it is 2*log(entry) and not log(entry)                                              */
...
inline void project_isotopic(quad_cyclic_cover *qcc, size_t nb_char, size_t* dimensions, double* projections)
{
  /*
...
void check_projection(quad_cyclic_cover *qcc, size_t nb_char, size_t* dimensions, double* projections)
{
