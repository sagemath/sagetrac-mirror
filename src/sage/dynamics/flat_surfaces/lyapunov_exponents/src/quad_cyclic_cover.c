...
{
  /*
    Check if everything is all right in our quad_cycle_cover qcc
  */
...
/*   Create a quad_cyclic_cover of given degree over a translation surface, with the given generalized_permutation for the interval exchange, */
