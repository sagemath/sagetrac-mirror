...
cdef fast_mandelbrot_plot(double x_center, double y_center,
...
cdef fast_external_ray(double theta, long D=30, long S=10, long R=100,
...
cdef convert_to_pixels(point_list, double x_0, double y_0, double width,
...
cdef fast_julia_plot(double c_real, double c_imag,
...
cdef julia_helper(double c_real, double c_imag, double x_center=0,
...
cdef polynomial_mandelbrot(f, parameter=None, double x_center=0,
...
cdef general_julia(f, double x_center=0, double y_center=0, image_width=4,
