...
class DynamicalSystem(SchemeMorphism_polynomial,
    ...
    def all_possible_global_periods(self,primes,e):
        r"""
        for several primes P with good reduction, find the list of possible global periods of a Dynamical System and return it
        ...
        EXAMPLES::
            ...
            sage: lst = []
            sage: for prime in FF.places_finite(1):
            ....:     lst.append(prime.local_uniformizer())
            sage: DS.all_possible_global_periods(lst, 1)
            [1, 2, 4, 64, 1088]
        """
        DS = copy(self)
        base = DS.base_ring()
