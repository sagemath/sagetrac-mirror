...
class Marking(SageObject):
    ...
    EXAMPLES::
        ...
        sage: from sage.dynamics.interval_exchanges.marked_partition import Marking
        sage: Marking('2o3')
        2o3
        sage: Marking('3|0')
        3|0
...
class MarkedPartition(SageObject):
    ...
    EXAMPLES::
        ...
        sage: from sage.dynamics.interval_exchanges.marked_partition import MarkedPartition
