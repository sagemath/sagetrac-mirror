...
def cobweb(a_function, start, mask=0, iterations=20, xmin=0, xmax=1):
    """
    Returns a graphics object of a plot of the function and a cobweb
...
def orbit_diagram(a_function, parameter_interval, domain=[0, 1],
    ...
    """
    Returns a plot of the iterations of a function as a function of a
    parameter value.
    ...
    NOTES: This is pretty crude so far.
    """
    point_list = []
