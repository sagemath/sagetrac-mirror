...
######                    Timings functions                    ######
#####################################################################
cdef ClonableArray cy_add1_internal(ClonableArray bla):
    """
    TESTS::
...
cdef ClonableArray cy_add1_immutable(ClonableArray bla):
    """
    TESTS::
...
cdef ClonableArray cy_add1_mutable(ClonableArray bla):
    """
    TESTS::
...
cdef ClonableArray cy_add1_with(ClonableArray bla):
    """
    TESTS::
