...
def _certify_names(names):
    """
    Test that the argument provides a list of valid variable names.
    ...
    A tuple of variable names obtained from ``names``.

    TESTS::

        sage: from sage.structure.parent_gens import _certify_names
        sage: _certify_names('abc')
        ('a', 'b', 'c')
