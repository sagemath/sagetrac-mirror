...
lazy_import('sage.algebras.hecke_algebras.iwahori_hecke_algebra', 'IwahoriHeckeAlgebra')

lazy_import('sage.algebras.hecke_algebras.iwahori_hecke_algebra_representations',
