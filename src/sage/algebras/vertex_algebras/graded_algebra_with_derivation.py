...
class AffineArcAlgebra(GradedCommutativeAlgebraWithDerivation,
    ...
    class Element(ElementWrapper):
        ...
        def reduce(self,I):
            r"""Reduce this element modulo the elements in ``I`` and their 
            derivatives

            INPUT::

                - ``I`` - a list of elements or a differential ideal

            EXAMPLES::

                sage: A = AffineArcAlgebra(QQ,'L', (2,)); L = A.0;
                sage: a = L**3; a
                L_2^3
                sage: b = L.T()**2*L + 3*L.T(2)**2; b
                L_2*L_3^2 + 12*L_4^2
                sage: b.reduce(a)
                -L_2^2*L_4 + 12*L_4^2
                sage: I = A.differential_ideal(a); I
                Differential ideal of The arc algebra over Rational Field generated by ('L',) generated by (L_2^3,)
                sage: b.reduce(I)
                -L_2^2*L_4 + 12*L_4^2
            ...
            """
            p = self.parent()
            from sage.categories.ring_ideals import RingIdeals as Ideals
            if I not in Ideals(p):
                I = p.differential_ideal(I)
            return I.reduce(self) 
        
        def lc(self):
            r"""The leading coefficient of this element

            EXAMPLES::
                sage: A = AffineArcAlgebra(QQ,'L', (2,)); L = A.0; b = L.T(3)*L**2 + L.T(2)*L.T()*L/2; b
                L_2*L_3*L_4 + 6*L_2^2*L_5
                sage: b.lc()
                1
