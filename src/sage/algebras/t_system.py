...
class TSystemBasic(IntegrableSystem):
    r"""
    A T-system.
    ...
    def __classcall__(cls, base_ring, cartan_type, spectral_ring=None, level=None):
        ...
        return super(TSystemBasic, cls).__classcall__(cls, base_ring, cartan_type, spectral_ring, level)
...
class TSystem(Parent, UniqueRepresentation):
    r"""
    A T-system.

    We use the presentation of a T-system given in [T-systems, Y-systems, ...]
    """
    @staticmethod
    def __classcall__(cls, base_ring, cartan_type, level=None):
        ...
        return super(TSystem, cls).__classcall__(cls, base_ring, cartan_type, level)
    ...
    def _repr_(self):
        ...
        if self._level is not None:
            ...
            res = ''
        return "{}T-system of type {} over {}".format(res, self._cartan_type, self.base_ring())
