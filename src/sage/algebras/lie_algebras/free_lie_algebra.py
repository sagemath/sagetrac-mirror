...
class FreeLieBasis_abstract(FinitelyGeneratedLieAlgebra, BindableClass):
    ...
    def __init__(self, lie, basis_name):
        ...
        FinitelyGeneratedLieAlgebra.__init__(self, lie.base_ring(), lie._names,
    ...
    def basis(self):
        ...
        return DisjointUnionEnumeratedSets(Family(PositiveIntegers(), self.graded_basis))
...
class FreeLieAlgebra(Parent, UniqueRepresentation):
    ...
    def __classcall_private__(cls, R, names):
        ...
        EXAMPLES::
            ...
            True
        """
        return super(FreeLieAlgebra, cls).__classcall__(cls, R, tuple(names))
    ...
    def gens(self):
        """
        Return the generators of ``self`` in the Hall basis.
        ...
        EXAMPLES::
            ...
            Free Lie algebra generated by (x, y) over Rational Field in the Hall basis
        """
        return self.Hall().gens()

    def gen(self, i):
        """
        Return the ``i``-th generator of ``self`` in the Hall basis.
    ...
    def a_realization(self):
        r"""
        Return a particular realization of ``self`` (the Hall basis).
