...
class QuaternionOrder(Parent):
    ...
    def isomorphism_to(self, other, *, conjugator=False):
        ...
        `\beta` such that `O' = \beta^{-1} O \beta`, rather
        than the ring isomorphism it defines.
        ...
        ::
            ...
            sage: beta = O0.isomorphism_to(O1, conjugator=True); beta
            -18/667*i - 1/1334*j + 1/1334*k
            sage: O1.unit_ideal() == ~beta * O0 * beta
            True
        ...
        Some random testing::
            ...
            sage: b = next(filter(bool, iter(Quat.random_element, None)))
        ...
        ims = [~beta * gen * beta for gen in Q.gens()]
