...
class SmoothCharacterGeneric(MultiplicativeGroupElement):
    ...
    def __call__(self, x):
        ...
        Non-examples::
            ...
            ...
            TypeError: no canonical coercion from Number Field in i with defining polynomial x^2 + 1 with i = I to Rational Field
            sage: chi(0)
            Traceback (most recent call last):
            ...
...
class SmoothCharacterGroupGeneric(ParentWithBase):
    ...
    def _coerce_map_from_(self, other):
        ...
        EXAMPLES::
            ...
            Traceback (most recent call last):
            ...
            TypeError: no canonical coercion from Group of smooth characters of Q_3* with values in Number Field in i with defining polynomial x^2 + 1 with i = I to Group of smooth characters of Q_3* with values in Rational Field
