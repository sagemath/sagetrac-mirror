...
class SiegelModularFormPrecision (SageObject):
    ...
    def get_contents_bound_for_semi_definite_forms(self):
        ...
        .. NOTE::
            ...
            If (a, b, c) is semi positive definite, then it is
            GL(2, Z)-equivalent to a the form (0, 0, g) where g is the
            contents (gcd) of a, b, c.
    ...
    def __le__(self, other):
        ...
        .. TODO::
            ...
            It seems everything should be <= infinity
        """
