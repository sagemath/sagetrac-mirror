...
#         return hash(self.__category) # Any reason not to use id?
    ...
    def _with_axiom_as_tuple(self, axiom):
        ...
        EXAMPLES::
            ...
            sage: Sets()._with_axiom_as_tuple(axioms.Finite())
            (Category of finite sets,)
            sage: Magmas()._with_axiom_as_tuple(axioms.Finite())
            (Category of magmas, Category of finite sets)
            sage: Rings().Division()._with_axiom_as_tuple(axioms.Finite())
            (Category of division rings,
             Category of finite monoids,
             Category of commutative magmas)
            sage: HopfAlgebras(QQ)._with_axiom_as_tuple(axioms.FiniteDimensional())
    ...
    def _with_axiom(self, axiom):
        ...
        When ``axiom`` is not defined for ``self``, ``self`` is returned::
            ...
            sage: Sets()._with_axiom(axioms.Associative())
            Category of sets
