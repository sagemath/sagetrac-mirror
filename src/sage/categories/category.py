...
class CategoryWithParameters(Category):
    ...
    .. automethod:: CategoryWithParameters._make_named_class
    """
...
class JoinCategory(CategoryWithParameters):
    ...
    .. automethod:: JoinCategory._repr_object_names
    .. automethod:: JoinCategory._repr_
    .. automethod:: JoinCategory._without_axioms
    """
