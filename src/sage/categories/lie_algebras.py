...
class LieAlgebras(Category_over_base_ring):
    ...
    class ParentMethods:
        ...
        def subalgebra(self, gens, names=None, index_set=None, category=None):
            ...
            return LieSubalgebra(self, gens, names, index_set, category)
        ...
        def is_abelian(self):
            ...
            EXAMPLES::
                ...
                False
            """
            return all(x._bracket_(y) == self.zero() for x in self.gens() for y in self.gens())
