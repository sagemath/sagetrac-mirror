...
#            tester.assertEqual(self(an_element), an_element, "element construction is not idempotent")
        ...
        def algebra(self, base_ring, category=None):
            ...
            semigroups, monoids, or groups::
                ...
                Free module generated by An example of a commutative monoid:
                 the free commutative monoid generated by ('a', 'b', 'c', 'd') over Rational Field
            ...
            We check that :trac:`18700` is fixed::
