...
class SubspaceFunctor(ConstructionFunctor):
    ...
    EXAMPLES::
        ...
        sage: M.<a,b> = CombinatorialFreeModule(ZZ, ["a", "b"]); M
        Free module generated by {'a', 'b'} over Integer Ring
        sage: N.<c,d> = CombinatorialFreeModule(ZZ, ["c", "d"]); N
        Free module generated by {'c', 'd'} over Integer Ring
        sage: N.coerce_map_from(M)
        sage: phi = M.module_morphism(on_basis=lambda x: {'a': c, 'b': d}[x], codomain=N)
        sage: N.register_coercion(phi)
        sage: N.coerce_map_from(M)
        Generic morphism:
        From: Free module generated by {'a', 'b'} over Integer Ring
        To:   Free module generated by {'c', 'd'} over Integer Ring
        sage: N(a), N(b)
        (c, d)
        sage: S = M.submodule([a + 2 * b]); S
        Free module generated by {0} over Integer Ring
        sage: S.category()
        Category of finite dimensional subobjects of modules with basis over Integer Ring
        sage: S.ambient()
        Free module generated by {'a', 'b'} over Integer Ring
        sage: F = S.construction()[0]; F
        SubspaceFunctor
        sage: T = F(N); T
        Free module generated by {0} over Integer Ring
        sage: T.category()
