...
class VertexAlgebras(Category_over_base_ring):
    ...
    class Quotients(QuotientsCategory):
        ...
        class ParentMethods:
            ...
            def _repr_(self):
                return "Quotient of {} by {}".format(self.ambient(),
                                                     self.defining_ideal())

            def an_element(self):
                return self.retract(self._ambient.an_element())
        ...
        class FinitelyGeneratedAsVertexAlgebra(
            ...
            class ElementMethods:
                ...
                def _action_from_partition_tuple(self,pt,negative=True):
                    ...
                    `p = [[1]]` and `L` is the unique generator of `V`,
                    ...
                    def find_singular(self,n):
                        ...
                        vertex algebras as well::
                            ...
                            (f_-1f_-1|0>,
                             ...
                             e_-1h_-1|0> + e_-2|0>,
                             e_-1e_-1|0>)
                            sage: Q = V.quotient(V.ideal([sing[0]]))
                    ...
                    class ElementMethods:
                        ...
                        def _mul_(self, other):
                            return self.parent().retract(
                                                self.lift().mul(other.lift()))

                        def _bracket_(self, other):
                            p = self.parent()
                            sl = self.lift()
                            ol = other.lift()
                            return {k:p.retract(v) for k,v in sl.bracket(ol).\
    ...
    class FinitelyGeneratedAsVertexAlgebra(CategoryWithAxiom_over_base_ring):
        ...
        class ParentMethods:
            ...
            def hilbert_series(self,ord):
                ...
                return sum(self.dimension_at_weight(n)*q**n for n in range(ord)).O(ord)
        ...
        class Quotients(QuotientsCategory):
            class ParentMethods:
                ...
                def gens(self):
                    return tuple(self.retract(g) for g in self.ambient().gens()
