...
class ComplexReflectionGroups(Category_singleton):
    ...
    This is the base category for subgroups of the special linear group
    ...
    `t` fixes a hyperplane pointwise and acts by a root of unity on its
    ...
    EXAMPLES::
        ...
        [Category of complex reflection groups, Category of groups,
    ...
    .. SEEALSO::
        ...
        :class:`ComplexReflectionGroups`, :class:`CoxeterGroups`,
        :mod:`sage.combinat.root_system` for finite real reflection groups.
    """
    ...
    class ParentMethods:
        ...
        def simple_reflection(self, i):
            ...
            if not i in self.index_set():
                raise ValueError("{} is not in the Dynkin node set {}".format(i,self.index_set()))
        ...
        def distinguished_reflection(self, i):
            r"""
            Return the `i`-th distinguished reflection of ``self``. For a
            definition of destinguished reflections, see
            :meth:`distinguished_reflections`.

            For `i` in `1, \ldots, N^*`, this gives the `i`-th
            distinguished reflection of ``self``.
            """
        ...
        def reflection(self, i):
            ...
            For `i` in `1, \ldots, N`, this gives the `i`-th reflection
            of ``self``.
            """
        ...
        def simple_reflections(self):
            r"""
            Return the simple reflections of ``self`` as a family indexed
            by ``self.index_set()``.
        ...
        def distinguished_reflections(self):
            ...
            of ``self``, indexed by ``self.hyperplane_index_set()``.
            ...
            EXAMPLES::
                ...
                Finite family {0: (1,6)(2,5)(7,8),
                 ...
                 4: (4,21,27)(10,22,28)(11,13,19)(12,14,20)(16,26,30)(17,18,25)(23,24,29),
                 5: (3,13)(4,24)(9,19)(10,29)(11,15)(12,26)(14,21)(16,23)(17,30)(18,27)(20,22)(25,28),
        ...
        def irreducible_components(self):
            r"""
            Return a list containing all irreducible components of ``self``
        ...
        def from_word(self, word, word_type='simple'):
            r"""
            Return the group element corresponding to the given
            word. Namely, if ``word`` is `[i_1, i_2, \ldots, i_k]`, then
            this returns the corresponding product of
            (simple/distinguished/all) reflections
            `t_{i_1} t_{i_2} \cdots t_{i_k}`.
            ...
            EXAMPLES::
                ...
                Irreducible finite complex reflection group of rank 3 and type (1,1,4)
    ...
    class ElementMethods:
        ...
        def is_reflection(self):
            r"""
            Return ``True`` if ``self`` is a reflection, i.e., if ``self``
            fixes a hyperplane pointwise.
            ...
            EXAMPLES::
                ...
                Irreducible finite complex reflection group of rank 3 and type (2,1,3)
                sage: [ t.is_reflection() for t in W.reflections() ]
        ...
        def apply_simple_reflections(self, word, side = 'right'):
            ...
            - side -- (defaut: ``'right'``) indicates multiplying from left
              or right

            EXAMPLES::

                sage: W = ComplexReflectionGroup((1,1,3)); W
                Irreducible finite complex reflection group of rank 2 and type (1,1,3)
    ...
    class Finite(CategoryWithAxiom):
        ...
        EXAMPLES::
            ...
            [Category of complex reflection groups, Category of finite groups]
            sage: ComplexReflectionGroups().Finite().all_super_categories()
            [Category of finite complex reflection groups,
             Category of complex reflection groups,
             Category of finite groups, Category of groups,
             Category of finite monoids, Category of monoids,
             Category of finite semigroups, Category of semigroups,
             Category of magmas, Category of finite enumerated sets,
             Category of enumerated sets,
             Category of finite sets, Category of sets,
             Category of sets with partial maps, Category of objects]

        Let us consider an example of a finite reflection group::

            sage: W = ComplexReflectionGroups().Finite().example(); W
            Finite complex reflection group of rank 4 and type (1,1,3) x (2,1,2)

            sage: W.reflections()
            Finite family {0: (1,8)(2,5)(9,12), 1: (1,5)(2,9)(8,12),
             2: (3,10)(4,7)(11,14), 3: (3,6)(4,11)(10,13),
             4: (4,14)(6,13)(7,11), 5: (3,13)(6,10)(7,14), 6: (1,9)(2,8)(5,12)}

        ``W`` is the correct category::
        ...
        class ParentMethods:
            ...
            def degrees(self):
                r"""
                Return the degrees of ``self``, as a list.
                """
            ...
            def nr_reflecting_hyperplanes(self):
                ...
                rank. For real groups, this coincides with the number of
                reflections.
            ...
            def is_irreducible(self):
                ...
                EXAMPLES::
                    ...
                    Finite complex reflection group of rank 5 and type (1,1,3) x (2,1,3)
                    sage: W.is_irreducible()
                    False
                """
            ...
            def is_well_generated(self):
                ...
                This is, if ``self`` is generated by `\ell` many reflections
                where `\ell` is the rank of ``self``.

                REMARK:

                - all finite real reflection groups are well generated,
                - the finite complex reflection groups of type `G(r,1,n)`
                  and of type `G(r,r,n` are well generated,
                - the finite complex reflection groups of type `G(r,p,n)`
                ...
                EXAMPLES::
                    ...
                    True
                """
                return (self in WellGeneratedComplexReflectionGroups()
                        or self.nr_simple_reflections() == self.rank())

            def is_real(self):
                r"""
                Return ``True`` if ``self`` is real.

                For irreducible reflection groups, this is equivalent to
                `2` is a degree of ``self``.
            ...
            def reflecting_hyperplanes(self):
                ...
                .. NOTE::
                    ...
                    This method does not yet work for non-crystallographic
                    types.
        ...
        class ElementMethods:
            ...
            def character_value(self):
                r"""
                Return the value at ``self`` of the character of
                the reflection representation `V` of ``self.parent()``.
                ...
                EXAMPLES::
                    ...
                    Irreducible finite complex reflection group of rank 2 and type (2,1,2)
                    sage: [ t.character_value() for t in W ]
                    [2, 0, 0, 0, 0, 0, 0, -2]

                    sage: W = ComplexReflectionGroup((3,1,2)); W
                    Irreducible finite complex reflection group of rank 2 and type (3,1,2)
                    sage: [ t.character_value() for t in W ]
        ...
        class Irreducible(CategoryWithAxiom):
            def example(self):
                ...
                EXAMPLES::
                    ...
                    Irreducible finite complex reflection group of rank 3 and type (4,2,3)
                """
                from sage.combinat.root_system.complex_reflection_group import ComplexReflectionGroup
...
class WellGeneratedComplexReflectionGroups(Category_singleton):
    ...
    class Finite(CategoryWithAxiom):
        ...
        Let us consider an example of a finite complex reflection group::
            ...
            Finite complex reflection group of rank 4 and type (1,1,3) x (3,1,2)

        ``W`` is in the category of finite complex reflection groups::
        ...
        def example(self):
            r"""
            Return an example of a well-generated finite complex reflection group.
        ...
        class Irreducible(CategoryWithAxiom):
            def example(self):
                r"""
                Return an example of an irreducible well-generated finite complex reflection group.

                EXAMPLES::

                    sage: WellGeneratedComplexReflectionGroups().Finite().Irreducible().example()
                    Irreducible finite complex reflection group of rank 3 and type (4,1,3)
                """
                from sage.combinat.root_system.complex_reflection_group import ComplexReflectionGroup
            ...
            class ParentMethods:
                ...
                def coxeter_number(self):
                    ...
                    irreducible reflection group.

                    This is defined to be the order of a regular element in
                    ``self``, and is equal to the highest degree of ``self``.
                ...
                def fuss_catalan_number(self, m, positive=False,
                    ...
                    It is given by the product of the `m`-th Fuss-Catalan
                    numbers of the irreducible components of ``self``. For an
                    irreducible finite reflection group, it is defined by
                    `\prod_{i = 1}^\ell \frac{d_i + mh}{d_i}`
                    ...
                    .. NOTE::
                        ...
                        - The Fuss-Catalan numbers for `G(r,1,n)` all coincide
                          for `r > 1`.
                    ...
                    if m not in ZZ or m <= 0:
                        raise ValueError("{} is not a positive integer".format(m))
                    h = self.coxeter_number()
                    if polynomial:
                        f = lambda n: q_int(n)
                    else:
        ...
        class ParentMethods:
            ...
            def catalan_number(self):
                ...
                It is given by the product of the Catalan numbers of the
                irreducible components of ``self``. For an irreducible finite
                reflection group, it is defined by
                `\prod_{i = 1}^{\ell} \frac{d_i + h}{d_i}` where
                `d_1, \ldots, d_{\ell}` are the degrees and where `h`
                is the Coxeter number.

                .. NOTE::

                    - For the symmetric group `S_n`, it reduces to the Catalan
                      number `\frac{1}{n+1}\binom{2n}{n}`.
