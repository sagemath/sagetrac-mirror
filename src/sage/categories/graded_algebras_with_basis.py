...
class GradedAlgebrasWithBasis(Category_over_base_ring):
    ...
    def example(self, generators = ('a','b','c'), degrees = 1):
        """
        Return an example of a graded algebra with basis as per
    ...
    class ParentMethods:
        ...
        def basis(self, degree=None):
            """
            Return the basis for (an homogeneous component of) this graded algebra.
        ...
        def homogeneous_component(self, degree):
            """
            Return the degree ``degree`` homogeneous component of this
            graded algebra.
