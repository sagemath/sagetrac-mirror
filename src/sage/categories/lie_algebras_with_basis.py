...
class LieAlgebrasWithBasis(Category_over_base_ring):
    """
    ...
    def super_categories(self):
        ...
        EXAMPLES::
            ...
            sage: LieAlgebrasWithBasis(QQ).super_categories()
            [Category of vector spaces over Rational Field]
        """
        return [LieAlgebras(self.base_ring()), ModulesWithBasis(self.base_ring())]
