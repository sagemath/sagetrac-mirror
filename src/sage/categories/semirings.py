    ...
    class SubcategoryMethods:
        ...
        def Differential(self, base_ring=None):
            ...
            TESTS::
                ...
                sage: Rings().Differential().__module__
                'sage.categories.modules'
            """
            from sage.categories.differential_semirings import DifferentialSemiringsCategory
            return DifferentialSemiringsCategory.category_of(self)
