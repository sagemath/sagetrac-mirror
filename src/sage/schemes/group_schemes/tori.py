...
One can define a lattice in 3 different ways :
    ...
    =====With a group and matrix actions for each generator===== 
    Using Lattice_ambient(group,actions).
    ...
    ======With a group and an integer=======
    Using Lattice_ambient(group, n)
    ...
    Using Lattice_ambient(List_of_matrices)
