...
def _compute_factored_isogeny_prime_power(P, l, n, split=.8):
    ...
    Sparse strategies were introduced in [DJP2014], §4.2.2.
    ...
    not equally fast::
        ...
        sage: (l,n), = P.order().factor()
        sage: phis = hom_composite._compute_factored_isogeny_prime_power(P,l,n)
        sage: for s in (0, 0.1, 0.5, 0.9, 1):
        ....:     phis == hom_composite._compute_factored_isogeny_prime_power(P,l,n, split=s)
        True
        True
        True
        True
