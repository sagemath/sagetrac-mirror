...
class ModularSymbol(SageObject):
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: m = EllipticCurve('11a1').modular_symbol(method="eclib")
            sage: m
    ...
    def _find_scaling_L_ratio(self):
        ...
        EXAMPLES::
            ...
            sage : m._scaling
            1
            sage: m = EllipticCurve('11a2').modular_symbol(method="eclib")
            sage: m._scaling
            5/2
            sage: m = EllipticCurve('11a3').modular_symbol(method="eclib")
            sage: m._scaling
            1/10
            sage: m = EllipticCurve('11a1').modular_symbol(method="sage")
            sage: m._scaling
            1/5
            sage: m = EllipticCurve('11a2').modular_symbol(method="sage")
            sage: m._scaling
            1
            sage: m = EllipticCurve('11a3').modular_symbol(method="sage")
            sage: m._scaling
            1/25
            sage: m = EllipticCurve('37a1').modular_symbol(method="sage")
            sage: m._scaling
            1
            sage: m = EllipticCurve('37a1').modular_symbol(method="eclib")
            sage: m._scaling
            -1
            sage: m = EllipticCurve('389a1').modular_symbol(method="eclib")
            sage: m._scaling
            -1/2
            sage: m = EllipticCurve('389a1').modular_symbol(method="sage")
            sage: m._scaling
            2
            sage: m = EllipticCurve('196a1').modular_symbol(method="sage")
            sage: m._scaling  
            1/2  

        Some harder cases fail::

            sage: m = EllipticCurve('121b1').modular_symbol(method="sage")
        ...
        TESTS::
            ...
            ...          E = EllipticCurve(la)
            ...          me = E.modular_symbol(method="eclib")
            ...          ms = E.modular_symbol(method="sage")
            ...
            sage: [EllipticCurve(la).modular_symbol(method="eclib")(0) for la in rk1]  # long time (1s on sage.math, 2011)
            [0, 0, 0, 0, 0, 0]
            sage: for la in rk1:  # long time (8s on sage.math, 2011)
            ...       E = EllipticCurve(la)
            ...       m = E.modular_symbol(method="eclib")
    ...
    def __scale_by_periods_only__(self):
        ...
        EXAMPLES::
            ...
            sage: m = E.modular_symbol(sign=+1, method="eclib")
            sage: m.__scale_by_periods_only__()
            Warning : Could not normalize the modular symbols, maybe all further results will be multiplied by -1, 2 or -2.
            sage: m._scaling
            1/5
...
class ModularSymbolECLIB(ModularSymbol):
    def __init__(self, E, sign, normalize="L_ratio"):
        ...
        The modular symbol can not be adjusted::
            ...
            sage: M = EllipticCurve('121d1').modular_symbol(method="eclib")
            sage: M(0)
            2
            sage: M = EllipticCurve('121d1').modular_symbol(method="eclib",normalize='none')
            sage: M(0)
            8

            sage: E = EllipticCurve('15a1')
            sage: [C.modular_symbol(method="eclib",normalize='L_ratio')(0) for C in E.isogeny_class(use_tuple=False)]
            [1/4, 1/8, 1/4, 1/2, 1/8, 1/16, 1/2, 1]
            sage: [C.modular_symbol(method="eclib",normalize='none')(0) for C in E.isogeny_class(use_tuple=False)]
            [1/4, 1/4, 1/4, 1/4, 1/4, 1/4, 1/4, 1/4]

        Currently, the interface for negative modular symbols in eclib is not yet written::

            sage: E.modular_symbol(method="eclib",sign=-1)
        ...
        TESTS (for trac 10236)::
            ...
            sage: E = EllipticCurve('11a1')
            sage: m = E.modular_symbol(method="eclib")
            sage: m(1/7)
            7/10
            sage: m(0)
            1/5
...
class ModularSymbolSage(ModularSymbol):
    def __init__(self, E, sign, normalize="L_ratio"):
        ...
        The modular symbol is adjusted by -2::
            ...
            sage: M = EllipticCurve('121d1').modular_symbol(method="sage")
            sage: M(0)
            2
            sage: M = EllipticCurve('121d1').modular_symbol(method="sage",normalize='none')
            sage: M(0)
            1

            sage: E = EllipticCurve('15a1')
            sage: [C.modular_symbol(method="sage", normalize='L_ratio')(0) for C in E.isogeny_class(use_tuple=False)]
            [1/4, 1/8, 1/4, 1/2, 1/8, 1/16, 1/2, 1]
            sage: [C.modular_symbol(method="sage", normalize='period')(0) for C in E.isogeny_class(use_tuple=False)]
            [1/8, 1/16, 1/8, 1/4, 1/16, 1/32, 1/4, 1/2]
            sage: [C.modular_symbol(method="sage", normalize='none')(0) for C in E.isogeny_class(use_tuple=False)]
            [1, 1, 1, 1, 1, 1, 1, 1]
