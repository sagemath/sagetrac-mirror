...
class EllipticCurvePoint_field(SchemeMorphism_point_abelian_variety_field):
    ...
    def ate_pairing(self, Q, n, k, t, q=None):
        ...
        .. NOTE::
            ...
            First defined in the paper of [HSV]_, the ate pairing can
            be computationally effective in those cases when the trace
            of the curve over the base field is significantly smaller
            than the expected value. This implementation is simply
            Miller's algorithm followed by a naive exponentiation, and
            makes no claims towards efficiency.
