...
This file contains the :class:`PolynomialRingWithBasisFromAmbientSpace`
and  :class:`FinitePolynomialRingWithBasisFromAmbientSpace` classes,
which are basis of the :class:`AbstractPolynomialRing`
and :class:`FiniteAbstractPolynomialRing`
"""
#*****************************************************************************
...
class PolynomialRingWithBasisFromAmbientSpace(PolynomialRingWithBasis):
    ...
    def equivalent_basis(self, abstract_polynomial_ring):
        r"""
        Return the ambient space basis of another abstract polynomial ring.
...
class FinitePolynomialRingWithBasisFromAmbientSpace(FinitePolynomialRingWithBasis):
    ...
    class Element(FinitePolynomialRingWithBasis.Element):
        def __invert__(self):
            """
            Invert ``self`` if ``self`` is composed by only one element. Otherwise,
