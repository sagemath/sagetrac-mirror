"""
Upperclasses for basis of of the ``MultivariatePolynomialAlgebra`` and ``FiniteMultivariatePolynomialAlgebra``
"""
#*****************************************************************************
...
#class Finite_bases(Category_realization_of_parent):
    #r"""
    #This category is the default catergry for bases of :class:``FiniteMultivariatePolynomialAlgebra``,
    #i.e. bases of :class:``MultivariatePolynomialAlgebra`` with a finite number of variables. It is really
    ...
    #INPUT:
        ...
        #- ``algebra_tower``, the base of :class:``MultivariatePolynomialAlgebra`` that correspond to
    ...
    #def algebra_tower(self):
        ...
        #- the base of :class:``MultivariatePolynomialAlgebra`` that correspond to
        #this base on an unset number of variables
...
class FinitePolynomialRingWithBasisFromMorphism(FinitePolynomialRingWithBasis):
    ...
    def __init__(self, abstract_polynomial_ring, polynomial_ring_tower, basis_name, basis_repr,**keywords):
        ...
        if "triangular" not in keywords or keywords["triangular"] is None:
