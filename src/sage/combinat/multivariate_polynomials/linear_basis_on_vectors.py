"""
Some basis for `MultivariatePolynomialAlgebra` and `FiniteMultivariatePolynomialAlgebra` :
...
class LinearBasisOnVectors(PolynomialRingWithBasisFromMorphism):
    ...
    def morphism_method_wrapper(self, n):
        monomial_basis_with_type = self._monomial_basis_with_type.finite_basis(n)
