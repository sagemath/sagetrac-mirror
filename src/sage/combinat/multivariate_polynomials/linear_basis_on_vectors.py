...
class LinearBasisOnVectors(PolynomialRingWithBasisFromMorphism):
    ...
    def group_type(self):
        r"""
        Return the group type of the group acting on ``self``.
...
class SchubertBasisOnVectors(LinearBasisOnVectors):
    ...
    def from_partition(self,part,nb_variables=None):
        r"""
        Return the Schubert polynomial corresponding to the partition,
    ...
    def from_schur(self, schur):
        r"""
        Return the Schubert polynomial corresponding to the given 
        Schur function
...
class FiniteLinearBasisOnVectors(FinitePolynomialRingWithBasisFromMorphism):
    ...
    def one_basis(self):
        r"""
        Return the index of the one of ``self``.
