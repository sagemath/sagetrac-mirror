...
def rooted_tree_iterator(n,verbose=False):
    ...
    EXAMPLES::
        ...
        sage: from sage.combinat.plane_tree import rooted_tree_iterator
...
def rooted_plane_tree_iterator(nmin,nmax=None, verbose=False):
    ...
    EXAMPLES::
        ...
        sage: from sage.combinat.plane_tree import rooted_plane_tree_iterator
...
def half_turn(t,i=None):
    ...
    EXAMPLES::
        ...
        sage: from sage.combinat.plane_tree import half_turn
...
def is_lyndon(t,s=None,d=None,verbose=False):
    ...
    EXAMPLES::
        ...
        sage: from sage.combinat.plane_tree import is_lyndon
...
def unrooted_plane_tree_iterator(nmin,nmax=None,verbose=False, check=False):
    ...
    EXAMPLES::
        ...
        sage: from sage.combinat.plane_tree import unrooted_plane_tree_iterator
...
def admissible_plane_tree_iterator(a,verbose=False):
    ...
    EXAMPLES::
        ...
        sage: from sage.combinat.plane_tree import admissible_plane_tree_iterator
        sage: for t,n,l in admissible_plane_tree_iterator(4): print t,"\n",n,l
        [0, 1, 2, 2, 1, 0]
        4 3
        [0, 1, 2, 1, 0]
        3 2
