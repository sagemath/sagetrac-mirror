...
class BidendriformBialgebras(Category_over_base_ring):
    ...
    EXAMPLES::
        ...
        sage: from sage.combinat.hopf_algebras.categories.bidendriform_bialgebras import BidendriformBialgebras
    ...
    def super_categories(self):
        ...
        """
        R = self.base_ring()
        return Category.join([DendriformAlgebras(R), DendriformCoalgebras(R)],
                             as_list=True)
