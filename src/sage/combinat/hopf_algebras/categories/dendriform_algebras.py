...
class DendriformAlgebras(Category_over_base_ring):
    ...
    def super_categories(self):
        ...
        TESTS::
            ...
            sage: from sage.combinat.hopf_algebras.categories.dendriform_algebras import DendriformAlgebras
    ...
    class ParentMethods:
        ...
        def m_product(self, l, r):
            ...
            (.. see:  :meth:``sage.combinat.hopf_algebras.categories.dendriform_algebras.DendriformAlgebras.\
                              WithBasis.ParentMethods.m_product``)
        ...
        class ParentMethods:
            ...
            def m_product(self, l, r):
                ...
                TESTS::
                    ...
                    sage: F = FQSym(QQ).F()
                    sage: a, b = F[3,1,2], F[1,2,3]
                    sage: a.m_product(b) == a * b
                    True
    ...
    class DualObjects(DualObjectsCategory):
        ...
        def extra_super_categories(self):
            ...
            """
            from sage.combinat.hopf_algebras.categories.dendriform_coalgebras import DendriformCoalgebras
            return [DendriformCoalgebras(self.base_category().base_ring())]

from sage.categories.misc.operators_tools import expand_binary_operator

expand_binary_operator(DendriformAlgebras, "left_product")
expand_binary_operator(DendriformAlgebras, "right_product")
expand_binary_operator(DendriformAlgebras, "m_product")
