r"""
Iterator over the conjugacy classes of Sn

.. TODO:

    Implement a fast gray code.
"""
...
def conjugacy_class_iterator(part, S=None):
    ...
    ``part``. The output is given as a list of tuples.
    ...
    In order to get real permutations, one can use the utility ``imap`` from
    ...
    One can specify on other underlying set::
