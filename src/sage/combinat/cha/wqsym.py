...
class WordQuasiSymmetricFunctions(UniqueRepresentation, Parent):
    ...
    S = Fundamental = LazyImport(
        "sage.combinat.cha._wqsym.fundamental_basis", "Fundamental")
    M = FundamentalDual = LazyImport(
        "sage.combinat.cha._wqsym.fundamental_dual_basis", "FundamentalDual")
    Me = Elementary = LazyImport(
        "sage.combinat.cha._wqsym.elementary_basis", "Elementary")
    Ms = Homogene = LazyImport(
        "sage.combinat.cha._wqsym.homogene_basis", "Homogene")
