...
def has_mathematica():
    ...
    EXAMPLES::
        ...
        sage: has_mathematica() # optional - mathematica
        True
    """
...
def has_macaulay2():
    ...
    EXAMPLES::
        ...
        sage: has_macaulay2() # optional - macaulay2
        True
    """
...
def has_octave():
    ...
    EXAMPLES::
        ...
        sage: has_octave() # optional - octave
        True
    """
...
def has_scilab():
    ...
    EXAMPLES::
        ...
        sage: has_scilab() # optional - scilab
        True
    """
...
def has_gurobi():
    ...
    EXAMPLES::
        ...
        sage: has_gurobi() # optional - Gurobi
        True
    """
    from sage.numerical.mip import MixedIntegerLinearProgram
    try:
...
def _lookup(software):
    ...
    EXAMPLES::
        ...
        sage: sage.doctest.external._lookup('internet') # optional - internet
        True
    """
...
class AvailableSoftware(object):
    ...
    EXAMPLES::
        ...
        ['cplex',
         ...
         'pandoc',
         'scilab']
        sage: 'internet' in available_software # optional - internet
        True
        sage: available_software.issuperset(set(['internet','latex'])) # optional - internet latex
        True
    """
    def __init__(self):
        """
    ...
    def issuperset(self, other):
        ...
        EXAMPLES::
            ...
            sage: from sage.doctest.external import available_software
            sage: available_software.issuperset(set(['internet','latex','magma'])) # optional - internet latex magma
            True
        """
        for item in other:
            if item not in self:
