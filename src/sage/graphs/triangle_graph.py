...
class TriangleGraph_2_3_infinity(SageObject):
    ...
    * _outgoing_edges is a list of two lists of n integers
    ...
    def _check(self):
        ...
        if (len(self._incoming_edges[0]) != n or
                len(self._incoming_edges[1]) != n or
                len(self._outgoing_edges[0]) != n or
                len(self._outgoing_edges[1]) != n):
    ...
    def num_loops(self, type=None):
        if type is None:
            ...
            for i in xrange(self._n):
                if self._outgoing_edges[0][i] == i:
                    i2 += 1
                if self._outgoing_edges[1][i] == i:
                    i3 += 1
            return (i2, i3)
    ...
    def graph(self):
        ...
        res.add_edges((i, self._outgoing_edges[0][i], 2)
                      for i in xrange(self._n))
        res.add_edges((i, self._outgoing_edges[1][i], 3)
                      for i in xrange(self._n))
    ...
    def spanning_tree(self, root=0, id=None, g2=None, g3=None, verbose=False):
        ...
        while True:
            ...
            if self._outgoing_edges[1][x0] != x0:
                ...
                l.add(x1)
                tree.add_edge(x0, x1, '3')
                l.add(x2)
                tree.add_edge(x0, x2, '3inv')
