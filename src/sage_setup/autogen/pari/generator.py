...
from sage_setup.autogen.pari.parser import (sage_src_pari,
        gp2c_filenames, read_all_desc, read_decl, parse_prototype)
...
class PariFunctionGenerator(object):
    ...
    def handle_pari_function(self, function, cname="", prototype="", help="", doc="", **kwds):
        ...
        # If the function has documentation, use gphelp to read it
        # and convert to ReST format.
        if doc:
            doc = get_rest_doc(function)

        self.write_method(function, cname, args, ret, cargs, f, doc)
    ...
    def __call__(self):
        ...
        """
        # Write code to include gp2c-generated files
        include_gp2c = ""
        ...
        self.gen_file.write(gen_banner % include_gp2c)
        self.instance_file = open(self.instance_filename, 'w')
        self.instance_file.write(instance_banner % include_gp2c)

        # First, write __init__() to call all init functions
        self.instance_file.write("    def __init__(self, *args, **kwds):\n")
        for v in D:
            if v.get("section") == "init":
                self.instance_file.write("        self.{}()\n".format(v["function"]))
        self.instance_file.write("        return\n\n")
