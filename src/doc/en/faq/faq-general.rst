...
For support about usage of Sage, there is a question-and-answers website (http://ask.sagemath.org/questions/) and an email list ``sage-support`` (http://groups.google.com/group/sage-support).

For support about development of Sage, there is an email list ``sage-devel`` (http://groups.google.com/group/sage-devel).
