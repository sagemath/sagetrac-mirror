...
build/make/Makefile: $(top_srcdir)/configure $(top_srcdir)/build/make/deps $(top_srcdir)/build/pkgs/*/*
	rm -f config.log
	mkdir -p logs/pkgs
	...
	@if [ -x config.status ]; then \
		...
		$(top_srcdir)/configure $$PREREQ_OPTIONS; \
	fi || ( \
...
download:
	...
	$(top_srcdir)/src/bin/sage-download-upstream

dist: build/make/Makefile
	$(top_srcdir)/sage --sdist
