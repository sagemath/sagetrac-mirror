SAGE_SPKG_CONFIGURE([singular], [
  SAGE_SPKG_DEPCHECK([ntl flint readline mpfr cddlib], [
    ...
    [
            ...
            PKG_CHECK_MODULES([SINGULAR],
                    ...
                    PKG_CHECK_VAR([SINGULAR_LIBDIR], [Singular], [libdir])
                    AS_IF([test x$SINGULAR_LIBDIR = x],
                          [SINGULAR_LIB_BASE="libSingular"],
                          [SINGULAR_LIB_BASE="${SINGULAR_LIBDIR}/libSingular"])
